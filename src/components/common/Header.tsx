...
const Header = ({ className = '' }: HeaderProps) => {
  ...
  { label: 'Profil Desa', href: '/village-profile', icon: 'BuildingLibraryIcon' },
  { label: 'UMKM', href: '/umkm-directory', icon: 'BuildingStorefrontIcon' },
  { label: 'IDM', href: '/idm', icon: 'ChartBarIcon' },
  { label: 'PPID', href: '/ppid', icon: 'DocumentTextIcon' },
  ...
  return (
    <header className={`w-full bg-card shadow-md fixed top-0 left-0 right-0 z-50 ${className}`}>
...
>
  ...
  <div className="flex flex-col leading-tight">
    <span className="font-headline font-semibold text-base lg:text-lg text-primary">
      Desa Bangunjaya
    </span>
    <span className="text-[10px] lg:text-xs text-muted-foreground hidden sm:block">
      Website Resmi Desa
    </span>
  </div>
</Link>
